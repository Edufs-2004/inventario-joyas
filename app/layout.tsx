...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode; }>) {
  ...
  // Si la ruta empieza con "/c", es la vista pública del cliente. NO mostramos el menú de admin.
  const esVistaPublica = pathname.startsWith('/c');
  ...
  return (
    <html lang="es">
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased`}>
        ...
        {esVistaPublica ? (
          /* ========================================= */
          /* LAYOUT PÚBLICO (Para tus clientes)        */
          /* ========================================= */
          ...
          /* ========================================= */
          /* LAYOUT PRIVADO (Para ti, con menú lateral)*/
          /* ========================================= */
